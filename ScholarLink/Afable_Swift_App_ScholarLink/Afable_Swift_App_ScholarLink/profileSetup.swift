...
struct ProfileSetupView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .onAppear {
                ...
                credentialFileName = verificationDocumentURL.isEmpty ? "" : "Existing document"
            }
        }
    }
    ...
    func completeSetup() async {
        ...
        if selectedRole == .tutor {
            ...
            let hasCredential = credentialFileData != nil || !verificationDocumentURL.isEmpty
            guard hasCredential else {
                setupMessage = "Attach at least one supporting credential."
                return
            }
